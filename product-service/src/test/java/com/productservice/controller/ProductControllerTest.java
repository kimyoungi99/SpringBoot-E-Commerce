...
class ProductControllerTest {
    ...
    public void init() {
        ...
        this.productController = new ProductController(new ProductService(this.kafkaTemplate, this.productDao, this.categoryServiceClient, this.ProductAddDeleteTopicName));
    }
